package com.pass.validator.controller.test;
...
public class PasswordValidationControllerTest {
	...
	private static final String ALPHA_NUMERIC = "ALPHA_NUMERIC_CHECK";
	private static final String CHAR_SEQUENCE = "CHAR_SEQUENCE_CHECK";
	private static final String LENGTH = "LENGTH_CHECK";
	private static final String SECURITY_PASSWORD_URI = "/api/pass/validator";
	...
	public void testPassword_null() {
		...
		ResponseEntity<String> responseEntity = restTemplate.postForEntity(SECURITY_PASSWORD_URI, password,
				String.class);
	...
	private void verfiyRuleResult(String password, HashMap<String, Boolean> expectedResult) throws JSONException {
		...
		for (int i = 0; i < ruleArray.length(); ++i) {
			...
			String ruleName = rule.getString("validatorName");
